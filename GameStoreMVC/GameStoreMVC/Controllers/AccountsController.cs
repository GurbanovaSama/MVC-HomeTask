...
using GameStoreMVC.DTOs.UserDTOs;
...
namespace GameStoreMVC.Controllers
{
    public class AccountsController : Controller
    {
        ...
        public AccountsController(AppDbContext appDbContext, UserManager<AppUser> userManager, SignInManager<AppUser> signInManager = null)
        {
